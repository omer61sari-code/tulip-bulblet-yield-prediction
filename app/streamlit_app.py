...
if run_prediction:
    ...
    bulblet_number, bulblet_weight = predict(
        species,
        application_tr,
    ...
    st.success(f"Predicted Number of Bulblets: {bulblet_number:.2f}")
    st.success(f"Predicted Bulblet Weight: {bulblet_weight:.2f} g")
...
"and integrated into machine learning predictions."
)
