...
def predict(species, application_tr, circumference, weight, mycorrhiza, bacteria):
    ...
    X = np.array([[species_enc, application_enc,
...
st.caption(
    "Optimum mycorrhiza and bacteria dose effects were simulated based on literature-informed dose–response assumptions."
)
